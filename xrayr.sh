...
rm -rf /etc/XrayR/htpn.crt
rm -rf /etc/XrayR/htpn.key
...
Nodes:
  -
    PanelType: "V2board" 
    ApiConfig:
      ApiHost: "https://4g.tintuc247.top"
    ...
    ControllerConfig:
      ...
      CertConfig:
        CertMode: file 
        CertDomain: "admin.4g.tintuc247.top" 
        CertFile: /etc/XrayR/htpn4g.crt
        KeyFile: /etc/XrayR/htpn4g.key
        Provider: cloudflare 
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        CertMode: file 
        CertDomain: "4g.tintuc247.top" 
        CertFile: /etc/XrayR/htpn.crt 
        KeyFile: /etc/XrayR/htpn.key
        Provider: cloudflare 
